  ...
  return (
    <ol className={Styles.ol}>
      <li className={Styles.li}>
        ...
        <ol className={Styles.ol}>
          ...
          <li>
            ...
            i&nbsp;Informacji o&nbsp;Działalności Gospodarczej pod adresem ul. Bażantowa 9/21,
            80-175 Gdańsk, NIP: 6040080451 (zwany dalej: „Usługodawcą”). Adres do korespondencji:
            ul. Bażantowa 9/21, 80-175 Gdańsk; adres e-mail: hi@typeofweb.com.
          </li>
        </ol>
      </li>
      <li className={Styles.li}>
        ...
        <ol className={Styles.ol}>
          <li>
            Serwis służy do prezentacji najnowszych artykułów, podcastów lub filmów (zwanych dalej:
            „Artykułami”) z polskich blogów, podcastów i kanałów YouTube (zwanych dalej: „Blogami”)
            o tematyce frontendu. Usługodawca świadczy usługę polegającą na udostępnianiu
            infrastruktury teleinformatycznej celem dodawania i&nbsp;przechowywania zbioru Blogów
            jak i&nbsp;Artykułów, oraz ich wyświetlania.
          </li>
          <li>
          ...
          <li>
            ...
            wyświetlania, podlega weryfikacji przez Usługodawcę i&nbsp;może zostać zmodyfikowany lub
            usunięty. Okres od dodania Bloga, do jego opublikowania w&nbsp;Serwisie, może trwać
            kilka dni.
          </li>
          <li>
            ...
            <ol className={Styles.ol}>
              ...
              <li>
                ...
                zgodę na ich wykorzystanie przez Usługodawcę w&nbsp;Serwisie, a&nbsp;także poza nim,
          ...
          <li>
            ...
            <ol className={Styles.ol}>
              ...
              <li>
                ...
                religijnym lub jakimkolwiek innym oraz propagujących faszyzm, nazizm, komunizm oraz
                inne zbrodnicze ideologie;
              </li>
          ...
          <li>
            ...
            szczególności w&nbsp;przypadku powzięcia wiarygodnej informacji o&nbsp;naruszeniu prawa
            lub Regulaminu.
          </li>
          <li>
      ...
      <li className={Styles.li}>
        ...
        <ol className={Styles.ol}>
          <li>
            ...
            roszczeniami w&nbsp;stosunku do Usługodawcy z&nbsp;tytułu naruszenia jakichkolwiek praw
            tych osób trzecich przez treści zamieszczone przez Użytkownika, Użytkownik ten wstąpi do
            sprawy w&nbsp;miejsce Usługodawcy oraz przejmie na siebie w&nbsp;całości koszty
          ...
          <li>
            ...
            Serwisu, a&nbsp;w przypadku gdy naruszone zostały przepisy prawa, również zawiadomieniem
            odpowiednich organów lub skierowaniem sprawy do sądu.
          </li>
          <li>
            Przez naruszenie Regulaminu rozumie się także namawianie innych osób do jego naruszenia,
            a&nbsp;także ułatwianie jego obchodzenia, jak również czerpanie korzyści majątkowych
            z&nbsp;tych czynności.
          </li>
        </ol>
      </li>
      ...
      <li className={Styles.li}>
        ...
        <ol className={Styles.ol}>
          <li>
            Podstawowym zagrożeniem każdego użytkownika Internetu, w&nbsp;tym osób korzystających z
            usług świadczonych drogą elektroniczną, jest możliwość zainfekowania systemu
            teleinformatycznego przez złośliwe oprogramowanie tworzone głównie w&nbsp;celu
            wyrządzania szkód, takie jak wirusy, robaki, czy konie trojańskie. Aby uniknąć zagrożeń
            z&nbsp;tym związanych, a&nbsp;w tym pojawiających się w&nbsp;momencie otwierania
            wiadomości e-mail, należy wyposażyć swoje urządzenia dostępowe w&nbsp;programy
            antywirusowe i&nbsp;pamiętać o&nbsp;ich bieżącej aktualizacji do najnowszych wersji.
            Korzystanie z&nbsp;usług świadczonych przez Internet wiąże się z&nbsp;możliwą
            działalnością hackerów, zmierzających do włamania się zarówno do Serwisu (np. ataki na
            witrynę lub serwer), jak i&nbsp;do systemu Użytkownika. Warto pamiętać, że mimo
            stosowania przez Usługodawcę różnorodnych, nowoczesnych technologii obronnych, nie
            istnieje w 100% skuteczne zabezpieczenie przed opisanymi wyżej niepożądanymi
            działaniami. Więcej na temat stosowanych przez Usługodawcę zasad ochrony danych znaleźć
            można w Polityce prywatności.
          </li>
        </ol>
      </li>
      <li className={Styles.li}>
        ...
        <ol className={Styles.ol}>
          <li>
            ...
            „Administratorem”). Adres do korespondencji: ul. Bażantowa 9/21, 80-175 Gdańsk; adres
            e-mail: hi@typeofweb.com
          </li>
          <li>
            Korzystanie z&nbsp;Serwisu wiąże się z&nbsp;przetwarzaniem danych osobowych Użytkowników
            w celu logowania Użytkownika - na podstawie art. 6 ust. 1 RODO, czyli zgody Użytkownika,
            przetwarzane są adres e-mail, imię i&nbsp;nazwisko oraz ewentualnie nazwa użytkownika.
          </li>
          <li>
            Dane osobowe nie są przetwarzane w&nbsp;celu zautomatyzowanego podejmowania decyzji bez
            wyraźnej zgody Użytkowników.
          </li>
          <li>
            Dane osobowe nie są przekazywane podmiotom trzecim i&nbsp;są przechowywane przez czas
            posiadania konta Użytkownika. W&nbsp;przypadku opublikowania komentarza przez
            zalogowanego Użytkownika, jego nazwa będzie widoczna dla wszystkich odwiedzających
            Serwis. Dane osobowe zgromadzone w&nbsp;związku z&nbsp;zamieszczeniem komentarza będą
            przechowywane przez czas wyświetlania tego komentarza, chyba że wcześniej Użytkownik
            poprosi o&nbsp;usunięcie komentarza.
          </li>
          <li>
            ...
            <ol className={Styles.ol}>
              ...
              <li>
                Prawo do usunięcia danych osobowych; Administrator może odmówić usunięcia danych, co
                do których ma podstawę do ich dalszego przetwarzania (np. realizacja obowiązku
                prawnego lub dochodzenia roszczeń lub obrony przed roszczeniami, które mogą być
                kierowane przeciwko Administratorowi);
              </li>
              <li>Prawo do żądania ograniczenia przetwarzania danych osobowych;</li>
              <li>
                Prawo do zgłoszenia sprzeciwu co do przetwarzania danych osobowych, jeżeli podstawą
                przetwarzania jest uzasadniony interes Administratora lub wykonywanie zadań
                w&nbsp;interesie publicznym;
              </li>
              <li>
                Prawo do cofnięcia zgody, jeżeli dane osobowe były przetwarzane na podstawie zgody
                użytkownika;
              </li>
          ...
          <li>
            Wszystkie powyższe prawa można zrealizować kontaktując się z&nbsp;Administratorem drogą
            elektroniczną pod adresem: hi@typeofweb.com. Zgłoszone żądania będą realizowane bez
            zbędnej zwłoki, nie później niż w&nbsp;terminie 30 dni od dnia otrzymania żądania.
            W&nbsp;tym terminie Administrator udzieli odpowiedzi lub poinformuje o&nbsp;ewentualnym
            wydłużeniu terminu i&nbsp;wyjaśni przyczyny. Jeżeli Administrator poweźmie wątpliwości
            co do tego, czy określone żądanie zostało zgłoszone przez osobę uprawnioną, może on
          ...
          <li>
            ...
            Administrator zapewnia podjęcie wszelkich środków bezpieczeństwa i&nbsp;ochrony danych
            osobowych wymaganych przez przepisy prawa. Dane osobowe są gromadzone z&nbsp;należytą
            starannością i&nbsp;odpowiednio chronione przed dostępem do nich przez osoby do tego
            nieupoważnione.
          </li>
          <li>
            Jeśli uważasz, że Administrator przetwarza dane osobowe niezgodnie z&nbsp;prawem, możesz
      ...
      <li className={Styles.li}>
        ...
        <ol className={Styles.ol}>
          <li>
            ...
            zestawienie zmian Regulaminu i&nbsp;utrzymanie tej informacji przez okres co najmniej 14
            kolejnych dni kalendarzowych.{' '}
          </li>
          <li>
            Zmiany Regulaminu wchodzą w&nbsp;życie w&nbsp;terminie podanym wraz z&nbsp;informacją
            o&nbsp;jego zmianie, nie wcześniej jednak niż po upływie 14 dni kalendarzowych od
            momentu poinformowania o&nbsp;zmianach Regulaminu, z&nbsp;tym zastrzeżeniem, że
            zmieniony Regulamin będzie wiązać Użytkownika, o&nbsp;ile nie zaprzestanie on
