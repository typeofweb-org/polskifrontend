          ...
          <ol className={styles.ol}>
            ...
            <li>
              ...
              <ol className={styles.ol}>
                ...
                <li>
                  Prawo do usunięcia danych osobowych; Administrator może odmówić usunięcia danych,
                  co do których ma podstawę do ich dalszego przetwarzania (np. realizacja obowiązku
            ...
            <li>
              ...
              drogą elektroniczną pod adresem: hi@typeofweb.com. Zgłoszone żądania będą realizowane
              bez zbędnej zwłoki, nie później niż w&nbsp;terminie 30 dni od dnia otrzymania żądania.
              W&nbsp;tym terminie Administrator udzieli odpowiedzi lub poinformuje
              o&nbsp;ewentualnym wydłużeniu terminu i&nbsp;wyjaśni przyczyny. Jeżeli Administrator
              poweźmie wątpliwości co do tego, czy określone żądanie zostało zgłoszone przez osobę
              uprawnioną, może on zadać kilka dodatkowych pytań w&nbsp;celu weryfikacji tożsamości
              zgłaszającego.
            </li>
            <li>
