  ...
  return (
    <div className={styles.container}>
      ...
      <ResponsivePanel className={styles.responsive} header="O serwisie" description="">
        ...
        <p className={styles.text}>Podstawowym założeniem "Polskiego Front-Endu" było zebranie tutaj <strong>całych blogów</strong>, a nie pojedynczych artykułów. Z tegi powodu selekcji treści mogę dokonywać jedynie na etapie dodawania danej strony do serwisu. Jako, że nie każdy pisze tylko i wyłącznie o front-endzie, to czasem może się tutaj pojawić wpis na temat, na przykład, PHP... Wydaje mi się jednak, że każdy blog czy strona, która pisze <strong>dużo o front-endzie</strong>, czy ogólniej o web developmencie, zasługuje by się tutaj znaleźć... Nawet jeśli front-end to nie jedyny poruszany tam temat.</p>
